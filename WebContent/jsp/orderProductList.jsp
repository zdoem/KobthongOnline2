            ...
            <table class="table table-hover">
                ...
                <tbody>
	                ...
	                <c:if test="${SS_ARR_ORDERLIST != null}" >   
		                ...
		                <c:forEach items="${SS_ARR_ORDERLIST}" var="productItems"  varStatus="loop">	                   
		                    ...
		                    <tr> 
		                        ...
		                        <%--
		                         ...
		                         <div class="media-body">
		                                ...
		                                <h5 class="media-heading">รหัสสินค้า <a href="productDesc.html?productId=${productItems.productId}">${productItems.productId}</a></h5>
		                        ...
		                        <td class="col-sm-1 col-md-1" style="text-align: center">
		                           <input  name="quantity${loop.index}" value="${productItems.productItems}"  type="email" class="form-control" id="exampleInputEmail1" />

		                        </td>
		                        <td class="col-sm-1 col-md-1 text-center"><strong>&nbsp;${productItems.productSale}&nbsp;</strong></td>
		                       
		                       <c:if test="${(productItems.productSale > 0) &&  (productItems.productItems > 0)}">
									<td class="col-sm-1 col-md-1 text-center"><strong><c:out value="${productItems.productSale*productItems.productItems}"/></strong></td>
		                        ...
		                        <button type="button" class="btn btn-danger" onclick="javascript:doOrderDelete(${productItems.productId});">
                    ...
                    <tr>
                        ...
                        <td>   </td>
                        <td><h5>รวม</h5></td>
                        <td class="text-right"><h5><strong><c:out value="${sumTotal}"></c:out></strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                        ...
                        <td class="text-right"><h5><strong><fmt:formatNumber minIntegerDigits="2" value="${pricePostpay}" /></strong></h5></td>
                    </tr>
                    <tr>
                        <td>   </td>
                        <td>   </td>
                    ...
                    <tr>
                        ...
                        <c:if test="${not empty SS_ARR_ORDERLIST}">
	                        <td><!-- Continue Shopping -->
				                    <button type="button"  id="btn-submit" class="btn btn-default" >
			                        <span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;&nbsp;ทำรายการต่อ&nbsp;&nbsp;
			                        </button></td>
			                        <td>
			                        <button type="button" class="btn btn-success" onclick="javascript:doCheckOut();">  Checkout <span class="glyphicon glyphicon-play"></span>
			                        </button>
	                        </td>                        
		                             <script>
